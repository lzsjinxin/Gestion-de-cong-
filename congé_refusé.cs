...
{
    public partial class congé_refusé : Form
    {
        ...
        public void MajData()
        {
...

            {
                ...
                string select = "select date_debut,date_fin,nbr_de_jour,date_retour,typee from conge_refusé where login_emp = '"+Login.login+"'";
        ...
        private void congé_refusé_Load(object sender, EventArgs e)
        {
        ...
        private void congé_refusé_Activated(object sender, EventArgs e)
        {
